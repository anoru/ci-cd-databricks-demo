...
from lab_project_demo.data.DataProvider import DataProvider
...
class ConsumerPipeline():
    def __init__(self, spark, input_path, output_path, model_name, stage, limit=None):
        ...
        self.limit = limit
        self.stage = stage
        self.data_provider = DataProvider(spark, input_path, limit)
    ...
    def run(self):
        ...
        from loans
        """).write.format('delta').mode('overwrite').option("overwriteSchema", "true").save(self.output_path)